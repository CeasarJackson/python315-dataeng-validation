# Compatibility Report — Python v1.8.1
...
```bash
python scripts/compare_reports.py <previous> v1.8.1
```

---

*Generated 2026-06-07 by Python 3.15 Data Engineering Validation Suite v1.2.0*
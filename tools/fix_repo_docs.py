...
Usage
-----
python tools/fix_repo_docs.py

Validation
----------
python -m py_compile tools/fix_repo_docs.py
python -m ruff check tools/fix_repo_docs.py
python -m black --check tools/fix_repo_docs.py

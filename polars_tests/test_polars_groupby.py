...
Path    : polars_tests/test_polars_groupby.py
...
Usage
-----
python -m pytest polars_tests/test_polars_groupby.py

Validation
----------
python -m py_compile polars_tests/test_polars_groupby.py
python -m ruff check polars_tests/test_polars_groupby.py
python -m black --check polars_tests/test_polars_groupby.py
python -m pytest polars_tests/test_polars_groupby.py
